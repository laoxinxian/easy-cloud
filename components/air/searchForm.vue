  ...
  <div class="search-form">
    ...
    <el-form ref="form" class="search-form-content" label-width="80px">
      <el-form-item label="出发城市">
        ...
        <!-- select 点击选中建议项时触发 -->
        <!-- 城市的默认sort在fetch-suggestions函数里面已经赋值为数组第一个参数的sort，所以select监听的时候，当鼠标点击了一个新的城市，就会给这个字段重新赋值为你选择的城市 -->
        <el-autocomplete
      ...
      <el-form-item label="出发时间">
        <!-- change 用户确认选择日期时触发 -->
        <el-date-picker v-model="form.departDate" @change="handleDate" type="date" placeholder="请选择日期" style="width: 100%;" />
      </el-form-item>
      <el-form-item label>
      ...
      <div class="reverse">
        <span @click="handleReverse">反</span>
      </div>
    </el-form>
  </div>
</template>
